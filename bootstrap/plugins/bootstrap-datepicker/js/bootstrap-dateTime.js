...
(function(factory) {
    ...
    Datepicker.prototype = {
        ...
        _process_options: function(opts) {
            ...
            //set datesEnable start
            o.datesEnabled = o.datesEnabled || [];
            if (!$.isArray(o.datesEnabled)) {
                var datesEnabled = [];
                datesEnabled.push(DPGlobal.parseDate(o.datesEnabled, format, o.language, o.assumeNearbyYear));
        ...
        getClassNames: function(date) {
            ...
            if (!this.dateIsEnabled(date) && this.o.datesEnabled.length > 0) {
                cls.push('disabled');
            }
