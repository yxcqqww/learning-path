...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            dist: {
                src: ["guanaihui/js/lib/jQuery/jquery-1.11.3.js", "bootstrap/3.3.4/js/bootstrap.js", "guanaihui/jssrc/jquery.cookie.js", "apps/www.guanaihui.com/jssrc/controller.js"],
            ...
            dist3: {
                src: ["guanaihui/js/lib/jQuery/jquery-1.11.3.js", "bootstrap/3.3.4/js/bootstrap.js", "apps/h5.metro.chengdu/jssrc/controller.js"],
                dest: "apps/h5.metro.chengdu/jssrc/app.js"
            },
            dist4: {
                src: ["guanaihui/js/lib/jQuery/jquery-1.11.3.js", "bootstrap/3.3.4/js/bootstrap.js", "guanaihui/jssrc/jquery.cookie.js", "apps/admin.guanaihui.com/jssrc/controller.js"],
                dest: "apps/admin.guanaihui.com/jssrc/app.js"
            }
        },
        /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
        压缩js
        ...
        uglify: {
            ...
            build3: {
                src: "apps/h5.metro.chengdu/jssrc/app.js",
                dest: "apps/h5.metro.chengdu/js/app.min.js"
            },
            build4: {
                src: "apps/admin.guanaihui.com/jssrc/app.js",
                dest: "apps/admin.guanaihui.com/js/app.min.js"
            },
        ...
        watch: {
            ...
            /*www.guanaihui.com*/
            online: {
                files: ['<%=config.online.less.src%>/**/*.less', '<%=config.online.less.mainsrc%>', '<%=config.online.less.src%>/*.less',
                    '<%=config.online.js.src%>/**/*.js', '<%=config.online.js.mainsrc%>', '<%=config.online.js.src%>/controller.js'
                ],
                tasks: ["less:one", "uglify:one"],
                options: {
                    nospawn: true,
            ...
            // admin.guanaihui.com
            admin: {
                files: ['<%=config.admin.less.src%>/**/*.less', '<%=config.admin.less.mainsrc%>', '<%=config.admin.less.src%>/*.less',
                    '<%=config.admin.js.src%>/**/*.js', '<%=config.admin.js.mainsrc%>', '<%=config.admin.js.src%>/controller.js'
                ],
                tasks: ["less:one", "uglify:one"],
                options: {
                    nospawn: true,
    ...
    grunt.registerTask("guanaihui-m", ["concat:dist2", "uglify:build2"]);
    grunt.registerTask("chengdu", ["concat:dist3", "uglify:build3"]);
    grunt.registerTask("admin", ["concat:dist4", "uglify:build4"]);
    ...
    grunt.registerTask("watch_online", ["watch:online"]); /*www.guanaihui.com 监视任务*/
    grunt.registerTask("watch_admin", ["watch:admin"]); /*admin.guanaihui.com监视任务*/
    //grunt.registerTask("watch_chengdu", ["watch:m"]); /*成都地铁监视任务*/
