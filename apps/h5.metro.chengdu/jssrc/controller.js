...
function Controller() {
    ...
    this.appStaticPrefix = this.staticDomain + "/apps/h5.metro.chengdu/js";
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    跳转native页面的
    -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/  
    this.nativeRedirectUrl="CDMetro://js.native/selcetStation";
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    this.request = function(apiUrl, data, params) {
        ...
        if (this.environment === "production" || this.environment === "test") type = "GET"; //只要是jsonp请求，type肯定为GET
        ...
        try {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    else if (data.code.toString() === "1000") {
