/*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 4. 备注：
 -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
function SpringBeautyController() {
    /*-----------------------------------------------------------------------------------------------------------------------------------------------------------------------
     继承于Controller基类
     -----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
...
初始化native 跳转Url
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
SpringBeautyController.prototype.initNativeRedirectUrl = function() {
    var classSelf = this;
    ...
    if (userAgent.match(/iPad/i) || userAgent.match(/iPhone/i) || userAgent.match(/iPod/i)) {
        ...
        setupWebViewJavascriptBridge(function(bridge) {
            $('.product-list .item').on('click', '.btn-booking', function(e) {
                var _this = $(this);
		...
		$('.product-list .item').on('click', '.btn-booking', function() {
			 var redirectUrl = "",
				   el = this,
