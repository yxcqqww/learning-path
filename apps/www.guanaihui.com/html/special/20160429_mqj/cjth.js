...
CjThController.prototype.loadProduct=function(){
    var Floor_1_API = '/template/getActivityData?id=1006&type=2',
        Floor_2_API = '/template/getActivityData?id=1007&type=2',
        Floor_3_API = '/template/getActivityData?id=1008&type=2',
        J_floor_1 = $('#J_floor_1'),
        J_floor_2 = $('#J_floor_2'),
        J_floor_3 = $('#J_floor_3');
    (function($) {
